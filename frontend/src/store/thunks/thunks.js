import {getInfo, getListRegion} from "../action/action";
...
export const sendRegistrationForm = sendPostRequest ('http://ec2-3-14-79-158.us-east-2.compute.amazonaws.com/api/v1/register', getListRegion)